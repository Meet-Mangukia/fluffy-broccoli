          ...
          {/* <!-- Recent Sales Start -->  */}
            ...
            <div className="container-fluid pt-4 px-0 ">
                <div className="bg-light text-center rounded p-4" style={{ maxWidth: '1000px' }}>
                    ...
                    <Link to="/">Home</Link>&nbsp;<i className="fa fa-chevron-right"></i>&nbsp;<Link to="/detail">Subject Name</Link>&nbsp;<i className="fa fa-chevron-right"></i> &nbsp;<Link to='/assignment'>Assignment Submission</Link>
                    </div>
                </div>
            </div>
            {/* url end */}
 ...
 <div className="container-fluid pt-2 px-0">
                ...
                <div className="col-sm-12 col-md-6 col-xl-3">
                    ...
                    <div className="col-sm-12 col-md-6 col-xl-9">
                        <div className="h-100 bg-light rounded p-4">
                            <div className="d-flex align-items-center justify-content-between mb-2">
                                <h6 className="mb-0">Assignent Submission</h6>
                            </div>
                        </div>
            ...
            {/* <div className="container-fluid pt-4 px-4">
                <div className="bg-light rounded-top p-4">
                    <div className="row">
                        ...
                        <br></br>
                        Distributed By <a className="" href="https://themewagon.com" target="_blank">ThemeWagon</a>
                        </div>
                    </div>
                </div>
            </div> */}
